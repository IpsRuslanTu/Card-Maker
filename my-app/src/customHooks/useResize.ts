...
export function useResize(
  resizeBlock: (index: number, sizeX: number, sizeY: number) => void,
//   setPosition: (position: positionType, index: number) => void,
  LeftTop: RefObject<HTMLDivElement>,
...
//   modelPos: positionType,
  ...
  useEffect(() => {
    ...
    const MIN_SIZE_BLOCK: number = 10;
  ...
  }, [resizeBlock, LeftTop, RightTop, LeftBottom, RightBottom, item, modelSize]);
}