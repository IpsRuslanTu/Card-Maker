...
const Img = (props: PropsType & Props) => {
    ...
    return (
        ...
        >
            ...
            { borderStyle !== 'none' ? <div className='corner leftTopCorner' ref={pointLeftTop}></div> : undefined }
            { borderStyle !== 'none' ? <div className='corner rightTopCorner' ref={pointRightTop}></div> : undefined }
            ...
            { borderStyle !== 'none' ? <div className='corner leftBottomCorner' ref={pointLeftBottom}></div> : undefined }
            { borderStyle !== 'none' ? <div className='corner rightBottomCorner' ref={pointRightBottom}></div> : undefined }
...
const mapDispatchToProps = (dispatch: Function) => {
    return {
        ...
        resizeImg: (index: number, width: number, height: number) => dispatch(resizeImg(index, width, height)),
